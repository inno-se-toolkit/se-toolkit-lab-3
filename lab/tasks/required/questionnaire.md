...
1. What happens when you call an endpoint without the API key? (status code): returns 401 when we called without an API key
2. Where do you set the API key value for Docker Compose? (file name): in env.docker.secret
